        ...
        var
            ...
            register = function () {
                ...
                var routeData = [
                    ...
                    //Bookings Routes
                    {
                        view: config.viewIds.bookings,
                        route: config.hashes.bookings,
                        title: 'Bookings',
                        callback: vm.bookings.activate
                    },
                    //Locations Route
                    {
                        view: config.viewIds.locations,
                        route: config.hashes.locations,
                        title: 'Locations',
                        callback: vm.locations.activate
                    },
                    // Invalid routes
                    {
                        view: '',
